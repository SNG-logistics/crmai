...
const SMS_TEMPLATES = [
  ...
  { label: '🎁 โปรโมชั่น', text: 'สมาชิกมหาเฮง! ฝากวันนี้รับโบนัส 20% สูงสุด 500บ. สอบถาม LINE: @mahaheng' },
  { label: '💰 แจ้งเตือน', text: 'แจ้งเตือน: มีรายการถอนเงิน {amount} บ. จากบัญชีของท่าน หากไม่ใช่ท่านติดต่อ LINE: @mahaheng' },
  { label: '✅ ยืนยัน',    text: 'ยืนยันการสมัครสมาชิกมหาเฮงเรียบร้อยแล้ว ยินดีต้อนรับ! เข้าเล่นได้ที่ mahaheng.com' },
